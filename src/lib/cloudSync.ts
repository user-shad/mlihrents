...
function mergeOpsPreferringLocalProofs(
  ...
  return {
    ...
    payments: mergePaymentLists(remote.payments, local.payments, revokedResidentLogins),
    invoiceMap: applyRemovedInvoices(
      mergeInvoiceMaps(remote.invoiceMap, local.invoiceMap, revokedResidentLogins),
      removedInvoiceIds,
    ),
    ticketMap: mergeTicketMaps(remote.ticketMap, local.ticketMap, revokedResidentLogins),
    paidIds: mergePaidIds(remote.paidIds, local.paidIds, removedInvoiceIds),
    removedInvoiceIds,
    revokedResidentLogins,
    invoiceExtensions: mergeInvoiceExtensions(
      remote.invoiceExtensions,
      local.invoiceExtensions,
      removedInvoiceIds,
    ),
